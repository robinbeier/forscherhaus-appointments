...
$lang['no_slot_fallback_trigger'] = 'No appointment fits? Contact us.';
$lang['no_slot_fallback_trigger_prominent'] = 'No appointment fits? Request contact.';
$lang['no_slot_fallback_title'] = 'No appointment fits?';
$lang['no_slot_fallback_body'] = 'Please contact the class teacher or the school office so we can find a suitable option.';
$lang['no_slot_fallback_hint'] = 'If you cannot reach anyone directly, please use the contact options above.';
...
$lang['notes'] = 'Notes';
$lang['room'] = 'Room';
$lang['room_hint'] = 'Enter the room or classroom name (optional).';
$lang['class_size_default'] = 'Class size';
$lang['invalid_class_size'] = 'Please enter a valid class size (whole number ≥ 0).';
...
$lang['add_to_apple_calendar'] = 'Add to Apple Calendar (.ics)';
$lang['appointment_overview_title'] = 'Appointment Overview';
$lang['open_calendar_options'] = 'Add this appointment to your calendar using one of the options below or note the date and time.';
...
$lang['appointment_registered_short'] = '✅ Appointment booked';
$lang['manage_appointment_cta'] = 'Change or cancel appointment';
$lang['manage_appointment_cta_locked'] = 'Appointment locked';
$lang['manage_link_hint'] = 'Please save this now: You will need this link to change or cancel your booking later.';
$lang['manage_link_locked_hint'] = 'This appointment can no longer be changed online. Please contact the school team if you need assistance.';
$lang['manage_link_label'] = 'Booking link';
$lang['copy_link_button'] = 'Copy booking link';
$lang['link_copied_confirmation'] = 'Link copied';
$lang['copy_link_fallback'] = 'Copy failed. Please copy the link manually.';
$lang['share_link_button'] = 'Share';
$lang['share_link_unavailable'] = 'Sharing is not available on this device.';
$lang['share_link_title'] = 'Appointment details';
$lang['share_link_text'] = 'Change or cancel the appointment via this booking link: %s';
$lang['save_pdf_button'] = 'Save PDF';
$lang['pdf_export_preparing'] = 'Preparing PDF download...';
$lang['pdf_export_ready'] = 'PDF download started.';
$lang['pdf_export_failed'] = 'PDF export failed. Please try again.';
$lang['pdf_export_time_suffix'] = '';
$lang['pdf_export_filename_prefix'] = 'Appointment-Confirmation';
$lang['pdf_export_duration_unit'] = 'min';
$lang['pdf_export_link_label'] = 'Booking link';
$lang['pdf_export_qr_caption'] = 'Scan with your phone to open the booking link.';
$lang['add_to_calendar_grouped'] = 'Add to calendar';
$lang['add_to_calendar_hint'] = 'The booking link is stored in the calendar entry.';
$lang['book_another_appointment_link'] = 'Book another appointment';
$lang['calendar_event_manage_hint'] = 'Manage appointment:';
...
$lang['password_recovery_contact_robin'] = 'Please contact Robin.';
...
$lang['statuses_filter_label'] = 'Statuses';
$lang['hide_providers_without_plan'] = 'Hide providers without plan';
$lang['target'] = 'Target';
$lang['booked'] = 'Booked';
$lang['open'] = 'Open';
$lang['refresh'] = 'Refresh';
$lang['total'] = 'Total';
$lang['booked_slots'] = 'Booked';
$lang['open_slots'] = 'Open';
$lang['fill_rate'] = 'Fill rate';
$lang['dashboard_after_15_heading'] = 'Slots after 15:00';
...
$lang['dashboard_after_15_status_neutral'] = 'Not evaluable';
$lang['dashboard_after_15_summary_neutral'] = 'Not evaluable';
$lang['dashboard_after_15_service_choose'] = 'Choose service';
$lang['expectation_conflict'] = 'Booking goal missed';
$lang['dashboard_booking_goal_missed'] = 'Booking goal missed';
$lang['dashboard_after_15_goal_missed'] = '15:00 goal missed';
$lang['no_plan_in_period'] = 'No working plan in period';
$lang['dashboard_options'] = 'Options';
$lang['dashboard_hide_without_target'] = 'Hide teachers without target';
$lang['dashboard_hidden_counter_pattern'] = '(%d hidden)';
$lang['dashboard_download_teacher_pdf'] = 'Teacher ZIP';
...
$lang['dashboard_export_select_all'] = 'All';
$lang['dashboard_export_select_none'] = 'None';
$lang['dashboard_export_no_teachers'] = 'No teachers available.';
$lang['dashboard_export_select_teacher_required'] = 'Please select at least one teacher for export.';
$lang['dashboard_conflict_threshold'] = 'Booking goal threshold';
$lang['dashboard_conflict_threshold_hint'] = 'Define the utilization threshold (0 - 1) below which providers are marked as booking goal missed.';
$lang['dashboard_conflict_threshold_invalid'] = 'Please provide a threshold between 0 and 1.';
$lang['dashboard_apply_threshold'] = 'Apply threshold';
$lang['dashboard_threshold_chip_label'] = 'Threshold';
$lang['dashboard_summary_title'] = 'Booking Progress';
$lang['dashboard_summary_subtitle'] = 'Overall view of the current booking progress.';
$lang['dashboard_summary_progress_label'] = 'Progress to 100%';
$lang['dashboard_summary_total_parents'] = 'Parents total';
$lang['dashboard_summary_booked'] = 'Booked';
$lang['dashboard_summary_open'] = 'Open';
$lang['dashboard_summary_threshold_badge'] = 'Threshold';
$lang['dashboard_summary_threshold_badge_pattern'] = 'Threshold %s';
$lang['dashboard_no_target'] = 'No target';
$lang['dashboard_target_fallback_badge'] = 'Capacity';
$lang['dashboard_target_fallback_hint'] = 'Estimated from planned capacity in the working plan.';
$lang['dashboard_slots_summary'] = 'Slots: %planned% / %required%';
$lang['dashboard_slots_summary_fallback'] = 'Slots: —';
$lang['dashboard_slots_gap_badge'] = 'Capacity gap';
$lang['dashboard_slots_gap_hint'] = 'Planned slots for the period are below the required target; already booked appointments do not reduce this planned value.';
$lang['dashboard_chart_booked'] = 'Booked';
$lang['dashboard_chart_open'] = 'Open capacity';
$lang['dashboard_heatmap_menu'] = 'Heatmap: Utilization by day & time';
$lang['dashboard_heatmap_title'] = 'Heatmap: Utilization by day & time';
$lang['dashboard_heatmap_loading'] = 'Loading heatmap…';
$lang['dashboard_heatmap_empty'] = 'No confirmed bookings for the selected period.';
$lang['dashboard_heatmap_legend_title'] = 'Legend (0 – 95th percentile)';
$lang['dashboard_heatmap_legend_hint'] = 'Values above the 95th percentile are shown with the maximum color intensity.';
$lang['dashboard_heatmap_context_pattern'] = '%range% · %minutes% min';
$lang['dashboard_heatmap_tooltip_bookings'] = 'Bookings';
$lang['dashboard_heatmap_tooltip_share'] = 'Share';
$lang['dashboard_heatmap_accessibility_weekday'] = 'Weekday';
$lang['dashboard_all_services_option'] = 'All services';
$lang['filter_period_required'] = 'Choose one day or a date range within the same Monday-to-Friday school week.';
...
$lang['search'] = 'Search';
$lang['dashboard_teacher_pdf_title'] = 'Teacher Report';
$lang['dashboard_teacher_dashboard_title'] = 'Teacher Dashboard';
$lang['dashboard_teacher_download_preparation_pdf'] = 'Preparation PDF';
$lang['dashboard_teacher_pdf_progress_title'] = 'Class Size Progress';
$lang['dashboard_teacher_pdf_metric_class_size'] = 'Class Size';
$lang['dashboard_teacher_pdf_metric_booked'] = 'Booked';
$lang['dashboard_teacher_pdf_metric_open'] = 'Open';
$lang['dashboard_teacher_pdf_metric_slots'] = 'Slots Planned / Required';
$lang['dashboard_teacher_progress_aria_label'] = 'Progress for booked and open appointments';
$lang['dashboard_teacher_appointments_heading'] = 'Appointment Overview';
$lang['dashboard_teacher_no_appointments'] = 'No appointments in the selected period.';
$lang['dashboard_teacher_mobile_time_label'] = 'Time';
$lang['dashboard_teacher_pdf_table_heading'] = 'Appointment Overview';
$lang['dashboard_teacher_pdf_table_parent'] = 'Parent Last Name';
$lang['dashboard_teacher_pdf_table_date'] = 'Date';
$lang['dashboard_teacher_pdf_table_start'] = 'Start';
$lang['dashboard_teacher_pdf_table_end'] = 'End';
$lang['dashboard_teacher_pdf_table_notes'] = 'Notes';
$lang['dashboard_teacher_pdf_outreach_title'] = 'Outreach';
$lang['dashboard_teacher_pdf_outreach_current_status'] = 'Current Status';
$lang['dashboard_teacher_pdf_outreach_variant_sdui'] = 'Sdui Variant';
$lang['dashboard_teacher_pdf_outreach_variant_phone'] = 'Phone Variant';
$lang['dashboard_teacher_pdf_outreach_checklist_title'] = 'Mini Checklist';
$lang['dashboard_teacher_pdf_slot_info_with_target'] = '%s of %s slots booked';
$lang['dashboard_teacher_pdf_slot_info_without_target'] = '%s slots booked';
$lang['dashboard_teacher_pdf_empty'] = 'No teachers found for the selected filters.';
$lang['dashboard_teacher_pdf_notes_placeholder'] = 'Space reserved for handwritten notes';
$lang['dashboard_teacher_pdf_no_appointments'] = 'No appointments in the selected period.';
$lang['dashboard_teacher_pdf_section_page_indicator'] = 'Page %s of %s';
$lang['dashboard_teacher_pdf_outreach_template_sdui'] = "Subject: Parent-Teacher Meeting – Booking\nDear {{Salutation}},\nI would like to invite you to book a slot for our parent-teacher meeting.\nWhen: {{Date/Period}} · Duration: {{Duration}}\nBooking: {{Link}}\nIf none of the available slots work for you, please let me know and we will find an alternative.\nWarm regards\n{{Teacher}}";
$lang['dashboard_teacher_pdf_outreach_template_phone'] = "Phone guide:\n1. Greet and refer to the parent-teacher meeting.\n2. Propose a suitable slot (mention {{Slot-Info}}).\n3. Offer the booking link or schedule the appointment directly.\n4. Offer alternative times if needed.";
$lang['dashboard_teacher_pdf_checklist_step_one'] = '1. Reminder sent';
$lang['dashboard_teacher_pdf_checklist_step_two'] = '2. Phone attempt documented';
$lang['dashboard_teacher_pdf_checklist_step_three'] = '3. Alternative times offered';
// End
