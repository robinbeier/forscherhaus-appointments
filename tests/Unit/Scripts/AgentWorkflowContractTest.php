    ...
    public function testStructuredContractDefinesExactHeadAndHighRiskInvariants(): void
    {
        ...
        self::assertSame(
            [
                ...
                'target_binding' =>
                    'canonical_open_main_pr_local_exact_head_and_branch_preflight_with_postwrite_revalidation',
                ...
                'response_policy' => 'discard_remote_body_and_emit_minimal_completed_write_status',
