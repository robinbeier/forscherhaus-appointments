    ...
    public function testStructuredContractDefinesExactHeadAndHighRiskInvariants(): void
    {
        ...
        self::assertSame(
            [
                ...
                'target_binding' =>
                    'canonical_open_main_pr_with_independent_matching_local_exact_head_and_branch_resolution_before_and_after_write_plus_remote_target_and_requested_update_revalidation',
