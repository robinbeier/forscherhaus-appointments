...
final class CustomersUiSmokeGateExecutionTest extends TestCase
{
    ...
    public static function browserFailureStagesProvider(): iterable
    {
        ...
        $navigationFailure['initial_search_request_seen'] = false;
        $navigationFailure['initial_search_request_allowed'] = false;
        $navigationFailure['initial_search_response_seen'] = false;
        $navigationFailure['initial_search_body_read'] = false;
        $navigationFailure['synthetic_search_request_seen'] = false;
        $navigationFailure['synthetic_search_request_allowed'] = false;
        $navigationFailure['synthetic_search_response_seen'] = false;
        $navigationFailure['synthetic_search_body_read'] = false;
        ...
        $syntheticSearchFailure['synthetic_search_response_seen'] = false;
        $syntheticSearchFailure['synthetic_search_body_read'] = false;
