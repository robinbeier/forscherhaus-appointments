...
class CiPerformanceBaselineTest extends TestCase
{
    ...
    public function testRepositoryPolicyDefinesAComparableFullGateCohort(): void
    {
        ...
        self::assertSame(16, $policy['workload_contract']['version']);
        self::assertSame('2026-09-05T10:52:45Z', $policy['workload_contract']['cohort_epoch_utc']);
    ...
    public function testBuildRunSampleRejectsRunsBeforeTheWorkloadContractEpoch(): void
    {
        ...
        self::assertContains(
            'workload_contract_mismatch: run predates cohort epoch 2026-09-05T10:52:45Z',
            $candidate['reasons'],
        );
    }
    ...
    {
        return gmdate('Y-m-d\TH:i:s\Z', strtotime('2026-09-05T11:00:00Z') + $afterSeconds);
    }
