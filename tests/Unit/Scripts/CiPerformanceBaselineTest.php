...
class CiPerformanceBaselineTest extends TestCase
{
    ...
    public function testBuildRunSampleMeasuresElapsedQueueJobsAndPhases(): void
    {
        ...
        $run = [
            'id' => 123,
            'created_at' => '2026-08-13T06:35:00Z',
            'conclusion' => 'success',
    ...
    public function testBuildRunSampleRejectsRunsBeforeTheWorkloadContractEpoch(): void
    {
        ...
        self::assertContains(
            'workload_contract_mismatch: run predates cohort epoch 2026-08-13T06:34:50Z',
            $candidate['reasons'],
        );
    }
    ...
    {
        return gmdate('Y-m-d\TH:i:s\Z', strtotime('2026-08-13T06:35:00Z') + $afterSeconds);
    }
