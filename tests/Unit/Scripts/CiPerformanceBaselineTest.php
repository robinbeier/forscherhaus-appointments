...
class CiPerformanceBaselineTest extends TestCase
{
    ...
    public function testBuildRunSampleMeasuresElapsedQueueJobsAndPhases(): void
    {
        ...
        $run = [
            'id' => 123,
            'created_at' => '2026-08-13T13:00:10Z',
            'conclusion' => 'success',
    ...
    public function testBuildRunSampleRejectsRunsBeforeTheWorkloadContractEpoch(): void
    {
        ...
        self::assertContains(
            'workload_contract_mismatch: run predates cohort epoch 2026-08-13T12:47:00Z',
            $candidate['reasons'],
        );
    }
    ...
    {
        return gmdate('Y-m-d\TH:i:s\Z', strtotime('2026-08-13T13:00:10Z') + $afterSeconds);
    }
