        ...
        if (
            !in_array(
                ...
                [
                    ...
                    'staff_api_provider_conflict',
                    'staff_api_admin_conflict',
                    'staff_api_alias_get',
                    'staff_api_provider_matching',
                    'services_api_conflict_put',
                    'services_api_matching_put',
                    'services_api_wrong_verb_destroy',
                    'services_api_invalid_duration',
                    'services_api_invalid_attendantsNumber',
                    'unavailabilities_api_conflict_put',
                    'unavailabilities_api_matching_put',
                    'unavailabilities_api_wrong_verb_destroy',
                    'blocked_periods_api_conflict_put',
                    'blocked_periods_api_matching_put',
                    'blocked_periods_api_wrong_verb_destroy',
                    ...
                    'race_reassignment',
                    'race_response',
                    'appointments_api_basic_create',
                    'appointments_api_bearer_create',
                    'appointments_api_denials',
                    'appointments_api_basic_update',
                    'appointments_api_bearer_update',
                    'appointments_api_basic_delete',
                    'appointments_api_bearer_delete',
                    'appointments_api_overlap_adjacency',
                    'appointments_api_overlap_auth_denials',
                    'appointments_api_overlap_parallel_dispatch',
                    'session',
                    'waiting',
                    'deactivate',
                    'verify',
