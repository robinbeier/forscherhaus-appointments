...
def validate_storage_scope(root: str, relative: str, operation: str) -> None:
    ...
    run_leaf = re.fullmatch(
        ...
        r'(run\.lock|intent\.json|request\.json|recovery-request\.json|execution-input\.json|recovery-execution-input\.json|state\.json|events\.jsonl|evidence\.json|operator-events\.jsonl|deploy-result\.json|deploy-post-gate-report\.json|rollback-post-gate-report\.json|deploy-systemd-launch\.json|deploy-unit-binding\.json|deploy-unit-observation\.json|rollback-systemd-launch\.json|rollback-unit-binding\.json|rollback-unit-observation\.json)',
        relative,
    )
    ...
    immutable = {
        'intent.json', 'request.json', 'recovery-request.json', 'execution-input.json', 'recovery-execution-input.json', 'deploy-result.json',
