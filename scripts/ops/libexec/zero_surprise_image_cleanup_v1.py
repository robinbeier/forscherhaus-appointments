...
ACTIVITY_PATTERNS = (
    ...
    re.compile(r"(^|/)(mysqldump|mariadb-dump|backup_easyappointments\.sh|backup_ea\.sh|ea_restore_verify_latest\.sh|backup_set_producer_v1\.py|fh-backup-set-producer-v1|prod_backup_set_producer\.sh)(\s|$)"),
)
COMPOSE_UP_PATTERNS = (
