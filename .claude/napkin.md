...
3. **[2026-03-09] Run Symphony tests without `tsx` IPC in sandboxed workers**
...
4. **[2026-03-06] Invoke Symphony workflow hook scripts through `bash`**
...
5. **[2026-03-05] Pin pre-PR gate context explicitly for non-main targets**
...
6. **[2026-03-03] Run Deptrac via Docker for stable local output**
...
7. **[2026-03-08] Keep pre-PR diff checks worktree-safe inside Symphony workers**
...
8. **[2026-03-08] Run lockfile-refresh gates from a committed lockfile baseline**
...
9. **[2026-03-08] Use containerized Playwright when host browser permissions are noisy**
...
10. **[2026-03-01] Fix MySQL InnoDB startup failures caused by FileProvider offload**
