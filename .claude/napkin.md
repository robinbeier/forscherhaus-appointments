...
2. **[2026-03-03] Scope `rg` to the repository/workspace root**
...
3. **[2026-03-02] When moving the repo root path, repair git + automation path dependencies**
...
4. **[2026-02-26] Detect iCloud duplicate placeholders before release rsync**
...
5. **[2026-03-01] Fix MySQL InnoDB startup failures caused by FileProvider offload**
...
6. **[2026-02-25] Keep deploy archive ID aligned with `deploy_ea.sh --rel`**
...
7. **[2026-02-23] Use unique Compose project names per worktree**
...
8. **[2026-02-22] Prefer `rg` for fast search**
