...
4. **[2026-03-06] Execute multi-PR plans strictly one PR at a time**
   Do instead: for a plan with multiple PRs, push one PR, follow the bounded PR follow-up loop in `WORKFLOW.md` until CI is green, review-clean, and mergeable, merge it, then start the next PR.
