...
- `SYMPHONY_LINEAR_API_KEY=fake SYMPHONY_LINEAR_PROJECT_SLUG=fake SYMPHONY_CODEX_COMMAND='codex app-server' npm --prefix tools/symphony run dev -- --check --workflow /Users/robinbeier/Developers/forscherhaus-appointments/WORKFLOW.md`
