...
| Production backup-set producer | `docs/ops/production-backup-set-producer.md` | Closed connection/dump authority, atomic set publication, manual-only execution, and ROB-461 two-set rollout. |
