...
| Production release and operator entry | `docs/ops/production-release-entry.md` | Short observed-facts, artifact, timer, deployment, probe, and recovery sequence; no authority by itself. |
