...
- Preserve the enabled retention-success Env setting. For separately approved
  future Env changes, follow `docs/uptime-kuma.md`; never print the protected
  Env or overwrite it with the example configuration.
