...
- Preserve the intentionally disabled retention-success Env setting
  (`KUMA_RELEASE_RETENTION_MONITOR_ENABLED=0`). For separately approved future
  reactivation, follow `docs/uptime-kuma.md`; never print the protected Env or
  overwrite it with the example configuration.
